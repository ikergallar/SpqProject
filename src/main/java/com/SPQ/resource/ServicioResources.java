...
public class ServicioResources {
	...
	public List<Anuncio> filtroCategoria(@QueryParam("categoria") String categoria) {
		...
		Query<Anuncio> query = pm.newQuery("javax.jdo.query.SQL",
				"select * from anuncio where categoria='" + categoria + "'");
		query.setClass(Anuncio.class);
		List<Anuncio> results = query.executeList();
	...
	public List<Anuncio> misAnuncios(@QueryParam("idusuario") int idUsuario) {
		...
		Query<Anuncio> query = pm.newQuery("javax.jdo.query.SQL",
				"SELECT * FROM anuncio where idusuario='" + idUsuario + "'");
		query.setClass(Anuncio.class);
		List<Anuncio> results = query.executeList();
	...
	public Anuncio seleccionarAnuncio(@QueryParam("nombre") String nombre) {
		...
		Query<Anuncio> query = pm.newQuery("javax.jdo.query.SQL",
				"SELECT * FROM anuncio where nombre='" + nombre + "'");
		query.setClass(Anuncio.class);
	...
	public Anuncio eliminarAnuncio(Anuncio anuncio) {
		...
		Query<Anuncio> query = pm.newQuery("javax.jdo.query.SQL",
				"DELETE  FROM anuncio where idanuncio='" + anuncio.getIdAnuncio() + "'");
		query.setClass(Anuncio.class);
