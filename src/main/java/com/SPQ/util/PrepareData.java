...
public class PrepareData {
	...
	public static void main(String[] args) throws IOException {	
		...
		try {
			...
			Anuncio anuncio=new Anuncio("Aitor", "Ofrdaezco servicio de fontaneria" ,60,"", Categoria.ALBAYIL,true, usuario.getIdUsuario());
			pm.makePersistent(anuncio);
			Anuncio anuncio1=new Anuncio("Aiadtor", "Ofrezco servicio de fontaneria" ,40,"", Categoria.ALBAYIL,false, usuario1.getIdUsuario());
			pm.makePersistent(anuncio1);
			Anuncio anuncio2=new Anuncio("sitor", "Ofrezdco servicio de fontaneria" ,20,"", Categoria.ALBAYIL,true, usuario2.getIdUsuario());
			pm.makePersistent(anuncio2);
			Anuncio anuncio3=new Anuncio("Aitoddr", "Ofrezco saaervicio de fontaneria" ,90,"", Categoria.ALBAYIL,true, usuario3.getIdUsuario());
